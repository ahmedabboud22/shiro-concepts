...
const page = () => {
  return (
    <>
      <Head>
        <title>Contact Us - Shiro Investment</title>
        <meta
          name="description"
          content="Contact us to start your journey toward success with Shiro Investment. We are here to assist you with your investment goals and inquiries."
        />
            ...
            >
              <div className="col-xl-9" style={{ backgroundColor: "#162341" }}>
                ...
                >
                  ...
                  investment solutions, expert advice, or have questions about
                  our services, our team is ready to support you.
                </p>
                <form>
                  <div
                    className="row"
                ...
                <div className="alert-success" style={{ display: "none" }}>
                  <h2>Thanks, your message is sent successfully.</h2>
                </div>
