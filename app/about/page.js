...
const page = () => {
  return (
    <PlaxLayout bg={false}>
            ...
            <div className="col-xl-8">
              <div className="mil-banner-text mil-text-center">
                ...
                <h1 className="mil-mb-60">
                  Beyond Business Redefining Financial Futures{" "}
                </h1>
              ...
              <ul className="mil-list-2 mil-type-2">
                <li>
                  <div className="mil-up">
                    <h5 className="mil-mb-15">At Shiro Concepts Investment</h5>
          ...
          >
            <div className="row justify-content-center mil-text-center">
              <div className="col-xl-8 mil-mb-80-adaptive-30">
                <h2 className="mil-up">What Sets Shero Apart?</h2>
              </div>
            </div>
            <div className="row">
              <div className="col-xl-4 mil-mb-60">
                <div className="mil-icon-box">
                  ...
                  <h5 className="mil-mb-20 mil-up">Unique by Design</h5>
              ...
              <div className="col-xl-4 mil-mb-60">
                <div className="mil-icon-box">
                  ...
                  <h5 className="mil-mb-20 mil-up">A Collaborative Journey</h5>
                  <p className="mil-text-m mil-soft mil-up">
          ...
          <div className="row flex-sm-row-reverse justify-content-between align-items-center">
            <div className="col-xl-6 mil-mb-80">
              ...
              <ul className="mil-list-2 mil-type-2">
                <li>
                  <div className="mil-up">
                    <h5 className="mil-mb-15">Our Vision</h5>
                    <p className="mil-text-m mil-soft">
                ...
                <li>
                  <div className="mil-up">
                    <h5 className="mil-mb-15">Our Mission</h5>
                    <p className="mil-text-m mil-soft">
      ...
      {/* team */}
      {/* quote */}
      <div className="mil-quote " style={{ backgroundColor: " #162341" }}>
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-xl-10">
              <h2 className="mil-mb-30">
                At Shero, we’re not just shaping investments — we’re shaping the
                  ...
                  <ul className="mil-list-2 mil-type-2 mil-mb-30">
                    <li>
                      <div className="mil-up">
                        ...
                        <p className="mil-text-m mil-soft">
                          Shero’s success lies in our ability to think
